...
[![npm version](https://img.shields.io/npm/v/node-red-contrib-iobroker)](https://www.npmjs.com/package/node-red-contrib-iobroker)
[![Pre-Release](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Marc-Berg/node-red-contrib-iobroker/main/.github/badges/beta.json&cacheSeconds=300)](https://github.com/Marc-Berg/node-red-contrib-iobroker/releases)
...
| **WS ioB delObj** | Delete object definitions (optional recursive) | Remove obsolete devices, channels, or states | [📖 Details](docs/nodes/iob-delobject.md) |
...
- **Default profile**: If multiple iob-config profiles exist, mark one as default for automatic selection in the editor

**Authentication Settings:**
- **No Authentication** (default): Leave username/password empty
- **OAuth2**: Enter valid ioBroker username/password

If only one iob-config profile exists, it is selected automatically. If multiple profiles exist, only the profile marked as default is selected automatically.
