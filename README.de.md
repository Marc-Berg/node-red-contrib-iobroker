...
| **WS ioB delObj** | Objektdefinitionen löschen (optional rekursiv) | Veraltete Devices, Channels oder States entfernen | [📖 Details](docs/nodes/iob-delobject.md) |
| **WS ioB inObj** | Objektänderungen überwachen | Adapter-Installationen verfolgen | [📖 Details](docs/nodes/iob-inobject.md) |
