// Original websocket-manager.js with MINIMAL wildcard support
...
class WebSocketManager {
    ...
    // MINIMAL wildcard change: Enhanced state change handler with pattern matching
    handleStateChange(stateId, state) {
        const matchingNodeIds = new Set();
        
        // Find all subscriptions that match this state
    ...
    // MINIMAL wildcard change: Simple pattern matching (only * supported by ioBroker)
