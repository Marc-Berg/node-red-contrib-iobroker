...
class OperationManager {
                    ...
                    if (pattern && pattern.includes('*')) {
                        if (objectType) {
                            ...
                            Promise.all(promises).then(results => {
                                ...
                                // Diagnostic: Output all found object IDs for comparison
                                const diagnosticIds = allObjects.map(obj => obj._id);
                                // You can inspect 'diagnosticIds' in a debugger or add a temporary output if needed
                                // ...existing code...
                                // ...existing code...
                                resolve(allObjects);
                            }).catch(err => {
    ...
    processObjectViewResult(result, pattern, objectType) {
        ...
        // Diagnostic: Output found IDs for this type
        // You can inspect 'objects.map(o => o._id)' in a debugger or add a temporary output if needed
