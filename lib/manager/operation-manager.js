 ...
 * Handles state and object operations with queueing
 */
...
class OperationManager {
    ...
    // NEW: Get multiple objects with wildcard pattern support
            ...
            return new Promise((resolve, reject) => {
                ...
                client.emit('getObjects', pattern, (err, objects) => {
                    ...
                    if (err) {
                        ...
                        // Convert object map to array if needed, preserving object structure
                        if (objects && typeof objects === 'object' && !Array.isArray(objects)) {
                            // ioBroker returns objects as a map, convert to array while preserving all info
