...
class OperationManager {
    constructor(connectionManager) {
        ...
        // Note: We handle operation execution directly in this class for smart logging
    ...
    destroy() {
        this.log.info('OperationManager cleanup started');
        ...
        this.log.info('OperationManager cleanup completed');
    }

    clearAllTimers() {
        // Clear any pending timeouts in queued operations
