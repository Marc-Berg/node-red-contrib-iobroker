/*!
 * Simple Node Registry - Direct Initial Value Request
 * No complex timing, events, or queues - just direct requests after subscription
 */
    ...
    async subscribe(nodeId, serverId, stateIdOrPattern, callback, config, isRecovery = false, manager) {
        try {
            ...
            if (client.isClientReady()) {
                ...
                // SIMPLE: Request initial value IMMEDIATELY after successful subscription
                ...
                try {
                    ...
                    if (callbackInfos) {
                        callbackInfos.forEach(info => {
                            ...
                            // SIMPLE: Request initial value immediately after resubscription
