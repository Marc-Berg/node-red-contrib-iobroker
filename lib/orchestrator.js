...
class Orchestrator extends EventEmitter {
    ...
    registerNode(nodeId, serverConfig) {
        ...
        if (!this.servers.has(serverId)) {
            this.servers.set(serverId, { config: serverConfig, nodes: new Set() });
            ...
            this.logger.debug(`Node ${nodeId} registered for already active server ${serverId}. Signaling ready.`);
